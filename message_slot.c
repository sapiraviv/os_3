...
void allocate_new_channel (ms_channel *curr_chanel, unsigned long ioctl_param){
...
void free_memory(ms_channel *current){
    ms_channel *prev;
    while (current != NULL){
        prev = current;
